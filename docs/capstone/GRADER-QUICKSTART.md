...
- PDF: `docs/capstone/submission/AURA_Forge_Final_Presentation.pdf`
- Contact sheet: `docs/capstone/submission/AURA_Forge_Slide_Preview.png`
- Speaker notes: `docs/capstone/submission/AURA_Forge_Speaker_Notes.md`

## Limitations

- The final walkthrough video is human-only and is not generated by Codex.
