...
| Audit trail | success |
| Overreach denial ID | `GO-20260811-001` |
| Tool-evolution drill commits | `7c666e5`, `4e446f6` |
| Change Passport example | `docs/capstone/evidence/change-passport-AF-HIGH-001.json` |
| Deterministic conversion | `scripts/check-config-docs-consistency.py`, `docs/capstone/deterministic-conversion.md` |
| ADR path | `docs/adr/` |
